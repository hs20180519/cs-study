...
### 2차 정규화(2NF)
- 제 1정규형을 만족해야 한다.
- 부분함수 종속 제거(완전 함수적 종속 제거), 주식별자 아닌 속성을 분리한다.
...
<img width="666" alt="image" src="https://github.com/user-attachments/assets/37a4b3c3-b909-4bec-a759-8de728f2981a">
...
- 4NF를 만족해야 한다.
- 조인 종속을 제거한다.
- A 릴레이션을 B와 C로 분해했다가 다시 조인했을 때 다시 A가 된다면 조인 종속이 있다.
<img width="645" alt="image" src="https://github.com/user-attachments/assets/348aa7fc-d2b5-46f6-a3a6-e45cfc70877c">
